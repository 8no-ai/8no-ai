...
echo "Starting 8no.ai update process..."
...
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/8no-ai/8no-ai/releases/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
