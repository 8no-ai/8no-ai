  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-xs text-codinit-elements-textSecondary font-medium">
        <img src="/icon-dark.png" alt="8no.Ai" className="w-3.5 h-3.5 dark:hidden" />
        <img src="/icon-light.png" alt="8no.Ai" className="w-3.5 h-3.5 hidden dark:block" />
        <span className="tracking-wide">8no.Ai</span>
      </div>
